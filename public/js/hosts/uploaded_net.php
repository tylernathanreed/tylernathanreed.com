			...
			if(empty($cookie)==false || ($user && $pass)){
				for ($j=0; $j < 2; $j++){
					...
					*/
					...
					if ($k == $maxacc-1 && stristr($data,"Downloads have been blocked for today")) die('<font color=red>You used too many different IPs, Downloads have been blocked for today.</font>');
					elseif (stristr($data,"<h1>Extend traffic</h1>")) {
						if($k <$maxacc-1) {
							$cookie = '';
							$this->save_cookies("uploaded.net","");
							break;
