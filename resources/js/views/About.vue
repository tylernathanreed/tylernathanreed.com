    ...
    <div>
        <jumbotron>
            ...
            <div class="d-flex flex-column flex-sm-row align-items-center w-100">
                ...
                <img class="masthead-avatar-lg mr-4" src="/images/avatar.webp" alt="Avatar">
                    ...
                    <div v-for="(item, key) in qualities" :key="key" class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" :data-target="`#portfolio-modal-${key}`">
                            ...
                            <div class="d-flex align-items-center p-2">
                                <div :class="`portfolio-item-icon ${item.icon} bg-${item.color} text-white p-2`"></div>
                                <div class="ml-3">
                                    <div>{{ item.name }}</div>
                                    <small class="text-muted text-xs">{{ item.description }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div v-for="(item, key) in practices" class="col-md-12 mb-4">
                        <div class="portfolio-item bg-white mx-auto w-100" data-toggle="modal" :data-target="`#portfolio-modal-${key}`">
                            ...
                            <div class="d-flex align-items-center p-2">
                                <div :class="`portfolio-item-icon ${item.icon} bg-${item.color} text-white p-2`"/>
                                <div class="ml-3 mr-3 flex-1">
                                    <div>{{ item.name }}</div>
                                    <small class="text-muted text-xs">{{ item.description }}</small>
                                </div>
                                <div v-if="item.thumbnail" class="portfolio-item-icon d-none d-sm-block">
        ...
        <!-- Portfolio Modals -->
        <portfolio-modal :item="qualities.virtuous">
            <p>
        ...
        <portfolio-modal :item="qualities.righteous">
            <p>
        ...
        <portfolio-modal :item="qualities.committed">
            <p>
        ...
        <portfolio-modal :item="qualities.initiative">
            <p>
        ...
        <portfolio-modal :item="qualities.leadership">
            <p>
        ...
        <portfolio-modal :item="qualities.integrity">
           <p>
        ...
        <portfolio-modal :item="practices.solid">
            <p>
        ...
        <portfolio-modal :item="practices.dry">
            <p>
        ...
        <portfolio-modal :item="practices.deeper">
            <p>
        ...
        <portfolio-modal :item="practices.tire">
            <p>
                The importance of technical communication is best summed up by this comic:
                <img src="/images/tireswing_full.png" class="w-100"/>
            </p>
            <p>
        ...
        <portfolio-modal :item="practices.future">
            <p>
        ...
        <portfolio-modal :item="practices.plane">
            <p>
            ...
            qualities() {
                return {
                    'virtuous': {
                        ...
                        'icon': 'fas fa-coins',
                        'color': 'yellow',
                        'description': 'The three greatest virtues are laziness, impatience, and hubris'
                    },
                    'righteous': {
                        'key': 'righteous',
                        'name': 'Be Righteous',
                        'icon': 'fas fa-check',
                        'color': 'green',
                        'description': 'Be justified in your actions, and accept when you\'re wrong'
                    },
                    'committed': {
                        'key': 'committed',
                        'name': 'Be Committed',
                        ...
                        'color': 'cyan',
                        'description': 'Get the job done, and put in the time to do it'
                    },
                    'initiative': {
                        'key': 'initiative',
                        ...
                        'icon': 'fas fa-running',
                        'color': 'gray',
                        'description': 'Do what needs to be done, don\'t wait to be told'
                    },
                    'leadership': {
                        'key': 'leadership',
                        ...
                        'icon': 'fas fa-users',
                        'color': 'purple',
                        'description': 'Lead by example, and teach others the lessons you\'ve learned'
                    },
                    'integrity':  {
                        'key': 'integrity',
                        'name': 'Show Integrity',
                        ...
                        'color': 'red',
                        'description': 'Be the rock for your team, and stand your ground on ethical issues'
                    }
                }
            },
            ...
            practices() {
                return {
                    ...
                    'tire': {
                        ...
                        'icon': 'fas fa-cog',
                        'color': 'gray',
                        'thumbnail': '/images/tireswing_thumbnail.png',
