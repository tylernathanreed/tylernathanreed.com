...
@section('content')
	...
	<div class="container bg-white shadow-md font-serif overflow-auto" style="max-width: 800px">
		<article class="px-4">
			<!-- Name -->
			<section>
			...
			<footer class="mb-6">
				...
				<div class="row">
					<div class="col-md-6 text-center">
						<a target="_blank" href="http://bit.ly/treed-resume-2019" class="btn btn-primary btn-lg w-1/2 whitespace-no-wrap">View on Google Docs</a>
					</div>
					<div class="col-md-6 text-center mt-6 md:mt-0">
						<a target="_blank" href="{{ url('files/Resume - 2019.pdf') }}" class="btn btn-primary btn-lg w-1/2">Download as PDF</a>
					</div>
				</div>
			</footer>
		</article>
